...
export type Contract_Filter = {
  ...
  registrationMetaEvidence_not_starts_with_nocase?: InputMaybe<
    Scalars["String"]
  >;
...
export type CounterQuery = {
  ...
  counter?: {
    ...
    challengedRemoval: any;
    challengedRegistration: any;
    registered: any;
    expired: any;
    removed: any;
  } | null;
...
export function getSdk(
  ...
  return {
    counter(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CounterQuery>(CounterDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "counter",
    ...
    submissions(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SubmissionsQuery>(SubmissionsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "submissions",
