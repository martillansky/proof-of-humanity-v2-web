...
const Vouch: React.FC<VouchingTooltipProps> = ({isActive, reason, name, photo, idx: key, href, pohId, address, isOnChain, reducedTooltip}) => {
    const avatarClassName = `w-8 h-8 rounded-full cursor-pointer ${!isActive? 'opacity-25' : ''}`;
